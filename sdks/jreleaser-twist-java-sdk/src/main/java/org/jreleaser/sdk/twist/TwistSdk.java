...
public class TwistSdk {
    ...
    public void createThread(Integer channelId, String title, String content) throws TwistSdkException {
        wrap(() -> {
            ThreadRequest request = new ThreadRequest(channelId, title, content);
            api.createThread(request);
        });
    }

    public void createComment(Integer threadId, String content) throws TwistSdkException {
        wrap(() -> {
            CommentRequest request = new CommentRequest(threadId, content);

...
class TwistAnnouncerImpl extends AbstractAnnouncer implements TwistAnnouncer {
    ...
    final Property<Integer> channelId
    final Property<Integer> threadId
    ...
    TwistAnnouncerImpl(ObjectFactory objects) {
        ...
        channelId = objects.property(Integer).convention(Providers.<Integer> notDefined())
        threadId = objects.property(Integer).convention(Providers.<Integer> notDefined())
